...
if (!function_exists('wd_ptable_shortcode')) {
	function wd_ptable_shortcode($atts, $content = null) {
        ...
        $html .= "<div class='wd_price_table ".$pricing_style."'>";
		...
		if ($pricing_style == "style2"): $html .= "<li class='cell table_title'><h1>".$title."</h1>";endif;
		if($pricing_style != "style2"):
		$html .= "<li class='cell table_title'><h1>".$title."</h1>";
        ...
        $html .= "</span>";
        $html .= "</div>"; //close price li wrapper
