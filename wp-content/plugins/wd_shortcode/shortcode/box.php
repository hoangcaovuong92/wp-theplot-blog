...
add_shortcode('Counter_militonre', 'TS_VCSC_Icon_Counter_Function1');
	function TS_VCSC_Icon_Counter_Function1 ($atts) {
		...
		if ($icon_position == 'top') {
			$output .= '<div id="' . $icon_counter_id . '" class="ts-icon-counter ' . $el_class . ' ts-counter-top ' . $icon_seperator . '  ' . $style . '  ' . $icon_tooltipclasses . ' ' . $css_class . '" ' . $icon_tooltipcontent . ' style="margiin-bottom: ' . $margin_bottom . 'px; margin-top: ' . $margin_top . 'px;">';
