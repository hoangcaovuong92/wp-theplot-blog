...
if(!class_exists('WP_Widget_EmAds')){
	...
	?>
			<p><label for="<?php echo esc_attr($this->get_field_id('img')); ?>"><?php _e('Image Url','wpdance'); ?> : </label>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('url')); ?>"><?php _e('Ads Url','wpdance'); ?> : </label>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('img_title')); ?>"><?php _e('Image title','wpdance'); ?> : </label>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('img_width')); ?>"><?php _e('Image Width','wpdance'); ?> : </label>
			...
			<p><label for="<?php echo esc_attr($this->get_field_id('img_height')); ?>"><?php _e('Image Height','wpdance'); ?> : </label>
