...
if(!function_exists ('wd_get_embbed_vimeo')){
	function wd_get_embbed_vimeo($video_url,$width,$height){
		return '<div class = "blog_video"><iframe src="//player.vimeo.com/video/'.wd_parse_vimeo_link($video_url).'?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="'.$width.'" height="'.$height.'" frameborder="0" webkitAllowFullScreen allowFullScreen></iframe></div>';
	}
}
